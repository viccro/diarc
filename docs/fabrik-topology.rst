:mod:`fabrik topology` - the diarc graph data structure
================================================
.. module:: topology
  :synopsis: the diarc graph data structure

This module contains the graph data structures used by the Fabrik diarc system.
...
.. class:: Vertex
    ...
    .. attribute:: sinks
        ...
        Unordered list of incoming connections. (:py:class:`Sink` objects)
